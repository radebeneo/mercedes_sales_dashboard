...
with col1:
    ...
    fig1 = px.line(sales_trend, x="Year", y="Sales Volume", color="Fuel Type", template="plotly_dark")
...
with col2:
    ...
    fig2 = px.bar(model_popularity, x="Model", y="Sales Volume", color="Fuel Type", barmode="group",
...
with col3:
    ...
    fig3 = px.pie(fuel_share, values="Sales Volume", names="Fuel Type", template="plotly_dark")
    st.plotly_chart(fig3, use_container_width=True)

with col4:
    st.subheader("Price Distribution")
    fig4 = px.histogram(filtered_df, x="Base Price (USD)", nbins=20, template="plotly_dark")
...
fig5 = px.scatter(scatter_df, x="Base Price (USD)", y="Horsepower", color="Fuel Type", hover_name="Model",
                  template="plotly_dark")
